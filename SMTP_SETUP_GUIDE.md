...
This guide will help you set up Gmail SMTP for the contact form to send emails to `mehedims2005@gmail.com` and `Moussajaafar8@gmail.com`.
...
### Option 2: Use Moussajaafar8@gmail.com (if it's Gmail)
```env
SMTP_USER=Moussajaafar8@gmail.com
SMTP_PASSWORD=<app-password-for-hello>
MAIL_FROM=Moussajaafar8@gmail.com
```
...
# "accepted: ['mehedims2005@gmail.com', 'Moussajaafar8@gmail.com']"
```
...
- [ ] Email received at Moussajaafar8@gmail.com
- [ ] No errors in logs
- [ ] Emails not in spam
...
**You're all set!** Contact form will now send to both `mehedims2005@gmail.com` and `Moussajaafar8@gmail.com`! 🎉
