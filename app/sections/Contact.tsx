...
const Contact = () => {
  const formName = "MoussaJa"; // Form name to keep it consistent with the API
  ...
  const contactInfo = [
    {
      ...
      link: "mailto:Moussajaafar8@gmail.com",
    },
    {
      icon: <FiPhone size={22} />,
      label: "Phone",
      value: "+961 81 913 762",
      link: "tel:+96181913762",
    },
    {
  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
      <div className="container mx-auto container-padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
              {/* Decorative elements */}
