...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Modern property management system with cloud-based architecture, SMS notifications, 100+ modules, and comprehensive reporting. Trusted by 50+ landlords in lebanon.",
      image: "/images/placeholder-project.svg",
